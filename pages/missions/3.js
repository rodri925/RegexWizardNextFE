...
const missionThree = () => {
  ...
  our customers have strong passwords. `,
    `I have determined that a strong password must meet these criteria: 1. The password must
  ...
  right, must be capitalized. There can be symbols before the first letter.`,
    'Could you help me find a regular expression that matches these criteria?',
    '-Regards,',
    'Steve',
  ];
  const initialText = '';
