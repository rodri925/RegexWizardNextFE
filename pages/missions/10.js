...
const missionTen = () => {
  ...
  const paragraphs = ['Dear Regex Wizards,',
    ...
    and all I need is the IPV4 address. Here are a couple of the strings. C
    ould you help me find a regular expression that matches all of the valid IP addresses?`,
  ];
  const initialText = '';
